...
import tn.edu.eniso.kombla.main.server.dal.CorbaMainServerDAO;
...
public class MainServerEngine extends AbstractMainEngine {
    ...
    protected void sceneActivating() {
        ...
        // put here your MainServerDAO instance - using CORBA implementation
        // dal = new TCPMainServerDAO();
        // dal = new UDPMainServerDAO();
        dal = new CorbaMainServerDAO();
